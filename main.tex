...
\newcommand{\titletext}{Adapting Single-View View Synthesis with Multiplane Images to 3D Video Chat}

% Bringing a 3D Effect to Video Chats by Synthesizing Novel Views via Multiplane Images / Video Chat View Synthesis with Multiplane Images / Adapting Single-View View Synthesis using Multiplane Images to Video Chat Scenarios / Dataset Experiments for Learning Single-View View Synthesis using Multiplane Images in Video Chat Scenarios
